  class Game
    ...
    def game_codebreaker
      ...
      until end_game?
        ...
        get_feedback(player_selection_code, @color_scheme_code)
    ...
    def game_codemaker
      ...
      get_feedback(player_selection_code, @color_scheme_code) # @codebreaker_guess
    ...
    def minimax(knuth_codes, possible_codes)
      ...
      possible_codes.each do |code|
        ...
        knuth_codes.each do |code_to_crack|
          ...
          times_found[feedback_to_string(feedback)] += 1
        end
      ...
      possible_codes.each do |code|
        guess_codes.append(code) if scores[code] == minimum
      end
